...
public interface RetrieveServicesAI extends java.rmi.Remote
{
	...
	*******************************************************/
	...
	String retrieveOrders(UserCredentials credentials) throws RemoteException;
	...
	*******************************************************/	
	...
	String retrieveOrders(String id, UserCredentials credentials) throws RemoteException;
}